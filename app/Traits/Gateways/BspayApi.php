...
trait BspayApi
{
    ...
    public function getBspay($request)
    {
        try {
    ...
    public function withdrawBspay($withdrawInfo)
    {
    ...
    public function getBspayAuth(): string
    {
        $bspayCred = Gateway::where('gateway_name', 'Bspay')->first();
        ...
        ])->asForm()->post('https://api.bspay.co/v2/oauth/token', [
